...
// ملاحظة: الـ anon key ده آمن يظهر في كود الواجهة (Frontend)،
// وده الغرض منه أصلًا. الحماية الحقيقية بتتحدد بقواعد Row Level Security
// جوه Supabase نفسه، مش بإخفاء المفتاح ده.
